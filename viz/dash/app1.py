...
layout = html.Div([
    ...
    html.Div([
        ...
        html.P(),
        html.P(),
        html.P("Cite As: Dong, L., Lee, H., Roh, S., & Theron, D. (2021, 12 7). S2-ProCLAIM: Protein Similarity Explorer.",
            className='projectlink'),
        html.A("https://people.ischool.berkeley.edu/~linda/capstone/protein-explorer/",
            href="https://people.ischool.berkeley.edu/~linda/capstone/protein-explorer/",
            className='projectlink'),
    ],
